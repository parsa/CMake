file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/console_task.cmake" [==[
...
set(lock "${CMAKE_CURRENT_BINARY_DIR}/console.lock")
...
add_custom_command(
  ...
  COMMAND "${CMAKE_COMMAND}"
          ...
          "-DOUT=${out1}"
          "-DNAME=one"
          -P "${CMAKE_CURRENT_BINARY_DIR}/console_task.cmake"
  DEPENDS "${CMAKE_CURRENT_BINARY_DIR}/console_task.cmake"
  USES_TERMINAL
  VERBATIM
)
